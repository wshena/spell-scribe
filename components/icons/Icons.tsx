...
export const FlipIcon: React.FC<Icons> = ({ style, size, color }) => {
  return (
    <MdOutlineFlipCameraAndroid className={style} size={size} color={color} />
  );
};
...
export const AngleLeftIcon: React.FC<Icons> = ({ style, size, color }) => {
  return <FaAngleLeft className={style} size={size} color={color} />;
};
